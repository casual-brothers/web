        ...
        <div className="mt-16 p-8 rounded bg-white/[0.02] border border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 hover:border-brand/20 transition-all duration-500">
          <div className="space-y-2 text-center md:text-left">
            <h4 className="font-display text-base font-bold text-white uppercase tracking-wider">
              {locale === 'es' ? '¿Buscas un Partner de Co-Desarrollo o Porting?' : 'Looking for a Co-Development or Porting Partner?'}
            </h4>
            <p className="text-sm text-white/45 max-w-2xl">
              {locale === 'es' 
                ? 'Conoce nuestras capacidades de producción, pipelines y cómo eliminamos riesgos para publishers e IP owners.' 
                : 'Explore our B2B production pipelines, team capacity, and how we de-risk game delivery for publishers & IP owners.'}
            </p>
          </div>
          <Link
          ...
          >
            {locale === 'es' ? 'Ver Capacidades B2B' : 'View B2B Capabilities'}
          </Link>
        </div>
      </div>
    </section>
