...
const SteamIcon = ({ className }: IconProps) => (
...
const PS4Icon = ({ className }: IconProps) => (
  <svg viewBox="0 9.3 24 5.4" fill="currentColor" className={className}>
...
const PS5Icon = ({ className }: IconProps) => (
  <svg viewBox="0 9.3 24 5.4" fill="currentColor" className={className}>
...
const XboxIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
const SwitchIcon = ({ className, isSplit }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    {/* Left Joy-Con */}
    <g className="transition-transform duration-300" style={{ transform: isSplit ? 'translateX(-1.5px)' : 'none' }}>
      <path d="M11.4 0H6.15C2.775 0 0 2.775 0 6.15v11.7C0 21.226 2.775 24 6.15 24h5.25c.074 0 .15-.074.15-.149V.15c.001-.076-.075-.15-.15-.15zM9.676 22.051H6.15c-2.326 0-4.201-1.875-4.201-4.201V6.15c0-2.326 1.875-4.201 4.201-4.201H9.6l.076 20.102zM3.75 7.199c0 1.275.975 2.25 2.25 2.25s2.25-.975 2.25-2.25c0-1.273-.975-2.25-2.25-2.25s-2.25.977-2.25 2.25z" />
    </g>
    {/* Right Joy-Con */}
    <g className="transition-transform duration-300" style={{ transform: isSplit ? 'translateX(1.5px)' : 'none' }}>
      <path d="M14.176 24h3.674c3.376 0 6.15-2.774 6.15-6.15V6.15C24 2.775 21.226 0 17.85 0H14.1c-.074 0-.15.074-.15.15v23.7c-.001.076.075.15.226.15zm4.574-13.199c1.351 0 2.399 1.125 2.399 2.398 0 1.352-1.125 2.4-2.399 2.4-1.35 0-2.4-1.049-2.4-2.4-.075-1.349 1.05-2.398 2.4-2.398z" />
    </g>
  </svg>
);
...
const EpicGamesIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  color: isHovered ? p.accentColor : "rgba(255, 255, 255, 0.35)",
                  filter: isHovered ? `drop-shadow(0 0 12px ${p.accentColor}bb)` : "none",
                }}
                title={p.name}
              >
                <p.icon
                  className={`${p.iconClass} transition-colors duration-300`}
                  isSplit={isHovered && p.name === "Nintendo Switch 2"}
                />
              </div>

              {/* Minimal version badge for Switch 2 */}
              {p.label && (
                <span
                  className="absolute -top-1 -right-2 flex items-center justify-center w-[13px] h-[13px] rounded-full border text-[7.5px] font-display font-black leading-none backdrop-blur-md transition-all duration-300"
                  style={{
                    color: isHovered ? p.accentColor : "rgba(255, 255, 255, 0.4)",
                    borderColor: isHovered ? p.accentColor : "rgba(255, 255, 255, 0.15)",
                    backgroundColor: isHovered ? `${p.accentColor}15` : "rgba(0, 0, 0, 0.4)",
                  }}
                >
                  {p.label}
                </span>
